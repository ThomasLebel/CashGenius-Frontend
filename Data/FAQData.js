const FAQ = [
  {
    question: "🧐 Rien est gratuit dans la vie, elle est où l'arnaque ?",
    answer: "Nulle part. Nous utilisons des liens de parrainages pour les inscriptions pendant le programme. Cela nous permet de toucher des commissions, de faire obtenir des bonus supplémentaires et donc de pouvoir proposer la méthode 100% GRATUITEMENT.",
  },
  {
  ...
  {
    question: "👵 Ma grand-mère de 80 ans elle peut le faire ?",
    answer: "Bien sûr ! Le programme est accessible à tous, aucunes connaissances en informatique ou en sport n'est nécessaire. Tout est expliqué de A à Z, il suffit d'avoir une connexion internet et de suivre les étapes à la lettre. Et puis ça te fera ça en plus sur l'héritage. Tout bénef !",
  },
  {
